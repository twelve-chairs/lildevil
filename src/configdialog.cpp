...
ConfigTab::ConfigTab(QWidget *parent) : QWidget(parent) {
    ...
    vlayout1->addWidget(comingSoon);
    testUrl = new QLineEdit();
//    testUrl->setMinimumWidth();
    ...
    vlayout2->addWidget(comingSoon2);
    ...
    vlayout3->addWidget(comingSoon3);
    ...
    vlayout4->addWidget(comingSoon4);
    ...
    vlayout8->addWidget(comingSoon8);
    ...
    vlayout5->addWidget(comingSoon5);
    ...
    connect(cancelButton, SIGNAL (released()), this, SLOT (cancelSettings()));
    buttonLayout->addWidget(cancelButton);
    auto *updateButton = new QPushButton("Update");
    connect(updateButton, SIGNAL (released()), this, SLOT (updateSettings()));
